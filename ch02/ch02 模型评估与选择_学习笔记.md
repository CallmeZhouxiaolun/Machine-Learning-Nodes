...
2. **性能度量**
   ...
   * 例如回归任务最常用的性能度量是：均方误差
   ...
   ​	3> F1: <img src="https://cdn.jsdelivr.net/gh/CallmeZhouxiaolun/Machine-Learning-Nodes@main/pic/1582190778882.png" width="85%" height="85%" alt="1582190778882" style="zoom:20%;" />
